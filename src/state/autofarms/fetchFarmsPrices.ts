...
import { VLX_USDT_LP_PID } from 'config/constants/autofarms'

const getFarmFromTokenSymbol = (
  farms: SerializedAutoFarm[],
  tokenSymbol: string,
...
const getFarmBaseTokenPrice = (
  farm: SerializedAutoFarm,
  quoteTokenFarm: SerializedAutoFarm,
...
const fetchFarmsPrices = async (farms: SerializedAutoFarm[]) => {
  const bnbBusdFarm = farms.find((farm) => farm.theirPid === VLX_USDT_LP_PID)
